...
; itos(dd number, dd str_addr)
; formed string contains null char (\0) at the end
; string memory must be at least 11 bytes
itos:
	push ebp
	mov ebp, esp
...
.push_byte:
	...
	jne .save_res			; then print number
...
.save_res:
	...
	mov byte [edi], 0		; put zero byte (\0) at the end
